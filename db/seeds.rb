...
Review.create([
    ...
    {
        subject: "My Childhood Favorite Book",
    ...
    {
        subject: "Beautiful Book for everyone",
        review: "It is the best novel I have ever read. I couldn't stop reading it. this is good for twelve-year-olds. This is a very descriptive and beautiful story, i highly ewcomend it.",
        rating: 4,
        user_id: 41,
        book_id: 4
    },
    {
        subject: "Good but movie is better",
        review: "It's an okay book. While you go on reading it you realise that Dan Brown was great only the first time you read him. 
        The book is good if you love his way of writing but then sometimes it gets irritating.",
        rating: 3,
        user_id: 38,
        book_id: 9
    },
    ...
    },
    {
        ...
        review: "I really really loveeee this book. It's the first David Walliams book I had ever read. It actually made me emotional in some parts and even though I usually like almost any nice big children's book this one is just *chef's kiss*.",
        rating: 5,
        user_id: 35,
        book_id: 3
    },
    {
        subject: "Bad work",
        review: "I've read most of Maas's work and love it, this wasn't it for me. Many of the action scenes were unclear and the character development was lacking.",
        rating: 2,
        user_id: 10,
        book_id: 5
    },
    {
        subject: "Err... Stay away from it",
        review: "I find this book highly racist, homophobic, and sexist. This book is not safe for anyone to read.",
        rating: 1,
        user_id: 35,
        book_id: 5
    },
